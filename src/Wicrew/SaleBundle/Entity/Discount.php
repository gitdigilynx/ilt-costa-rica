 ...
 * Discount
 *
 * @ORM\Table(name="Discount", uniqueConstraints={@ORM\UniqueConstraint(name="id_UNIQUE", columns={"id"})})
 * @ORM\Entity
...
class Discount extends BaseEntity {
     ...
     * @return Discount
     */
    public function setTypeDiscount($typeDiscount): Discount {
     ...
     * @return Discount
     */
    public function setId($id): Discount {
        $this->id = $id;
        return $this;
    }
     ...
     * @return Discount
     */
    public function setAmount($amount): Discount {
        $this->amount = $amount;
        return $this;
    }
     ...
     * @return Discount
     */
    public function setModifiedAt(\DateTime $modifiedAt): Discount {
