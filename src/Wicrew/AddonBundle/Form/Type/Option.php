...
class Option extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
            ...
            ->add('priceType', ChoiceType::class, [
                ...
                'placeholder' => 'core.option.please_select',
                'choices' => [
                    'addon.option.price_type.per_person' => AddonOption::PRICE_TYPE_PER_PERSON,
                    'addon.option.price_type.for_the_trip' => AddonOption::PRICE_TYPE_FOR_THE_TRIP
                ]
            ])
    ...
    public function configureOptions(OptionsResolver $resolver) {
        $resolver->setDefaults([
            'data_class' => 'App\Wicrew\AddonBundle\Entity\AddonOption',
